...
//*        DD DSN=CEE.SCEERUN,DISP=SHR              CEE RUNTIME
//*        DD DSN=USER.LOADLIB,DISP=SHR             USER LOADLIB
//*        DD DSN=IMS.LIB1,DISP=SHR                 IMS LIBRARY(IES)
//*PROCLIB DD DISP=SHR,DSN=IMS.PROCLIB              IMS PROCLIB
//* -------------------------------------------------------
//*IMS     DD DSN=IMS.PSBLIB,DISP=SHR   NEEDED IF GSAM USED
//*        DD DSN=IMS.DBDLIB,DISP=SHR   NEEDED IF GSAM USED
